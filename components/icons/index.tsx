...
export const PackageIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16.5 9.4a4.5 4.5 0 1 0-9 0" /><path d="M12 12.9a4.5 4.5 0 0 0 4.5 4.5h0a4.5 4.5 0 0 0 4.5-4.5V10.1" /><path d="m12 12.9 4.5 4.5" /><path d="M12 12.9a4.5 4.5 0 0 1-4.5 4.5h0a4.5 4.5 0 0 1-4.5-4.5V10.1" /><path d="m12 12.9-4.5 4.5" /><path d="M7.5 9.4a4.5 4.5 0 1 0 9 0" /><path d="M12 2.9a4.5 4.5 0 0 0-4.5 4.5v.1" /><path d="m12 7.4 4.5-4.5" /><path d="M12 2.9a4.5 4.5 0 0 1 4.5 4.5v.1" /><path d="m12 7.4-4.5-4.5" /></svg>
);
